...
1. In the window that appears, verify the user or bucket that you want to allow \(automatically preselected and matching the user or bucket listed in the alert's summary\) and then choose **Submit**\.
